# GEMINI AI SEC-SACNNER

Gemini AI SEC-SCANNER is a Python-based tool that leverages **Google's Gemini AI** to analyze network security scans, detect vulnerabilities, and provide technical insights. It automates **Nmap** and **Gobuster** scans, generating a professional vulnerability report for security professionals and IT students.
...
* Replace `api\_key` with your actual API key in `config.py`:

&#x20;   ```
    GEMINI\_API\_KEY="aaddxxxxx"
    ```
